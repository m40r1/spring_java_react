...
public class Destino {
	...
	public String toString() {
		return "Destino [" + (continente != null ? "continente=" + continente + ", " : "")
				+ (descricaoViagem != null ? "descricaoViagem=" + descricaoViagem + ", " : "") + "id=" + id + ", "
				+ (nome != null ? "nome=" + nome + ", " : "") + (pais != null ? "pais=" + pais + ", " : "")
				+ "qtTickets=" + qtTickets + "]";
	}
	 ...
	 * @param descricaoViagem
	 */
	public Destino(final long id, final String nome, final int qtTickets, final String continente, final String pais,
	 ...
	 * @param descricaoViagem
	 */
	public Destino(final String nome, final int qtTickets, final String continente, final String pais,
			final String descricaoViagem) {
		this.nome = nome;
		this.qtTickets = qtTickets;
		this.continente = continente;
